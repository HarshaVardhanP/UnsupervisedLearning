...
legend('Train - RBM Pretrained','Train - AutoEncoder Pretrained','Location','northwest')
title('Training Classification Accuracy')

subplot(1,2,2),plot(valid_Cerr(:,1)), hold on
subplot(1,2,2),plot(valid_Cerr(:,2)) 
legend('Valid - RBM Pretrained','Valid - AutoEncoder Pretrained','Location','northwest')
